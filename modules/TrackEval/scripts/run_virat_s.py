...
if __name__ == '__main__':
    ...
    default_dataset_config = trackeval.datasets.ViratS.get_default_dataset_config()
    default_metrics_config = {'METRICS': [
        'HOTA', 'CLEAR', 'Identity', 'VACE'], 'THRESHOLD': 0.5}
    ...
    dataset_list = [trackeval.datasets.ViratS(dataset_config)]
    metrics_list = []
