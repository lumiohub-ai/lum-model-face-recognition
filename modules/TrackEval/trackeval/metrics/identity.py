...
class Identity(_BaseMetric):
    ...
    def get_default_config():
        ...
        default_config = {
            ...
            'THRESHOLD': 0.5,
            # Whether to print the config information on init. Default: False.
            'PRINT_CONFIG': True,
        }
    ...
    def eval_sequence(self, data):
        ...
        fp_mat = np.zeros((num_gt_ids + num_tracker_ids,
                          num_gt_ids + num_tracker_ids))
        fn_mat = np.zeros((num_gt_ids + num_tracker_ids,
                          num_gt_ids + num_tracker_ids))
    ...
    def _compute_final_fields(res):
        ...
        res['IDF1'] = res['IDTP'] / \
            np.maximum(1.0, res['IDTP'] + 0.5 *
                       res['IDFP'] + 0.5 * res['IDFN'])
        return res
